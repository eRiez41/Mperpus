...
$filterStatus = 'dikembalikan'; // Mengatur filter status menjadi "dikembalikan" secara default
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT peminjaman.*, anggota.nama AS nama_peminjam, GROUP_CONCAT(buku.judul SEPARATOR ', ') AS judul_buku
                                            ...
                                            WHERE peminjaman.status = 'dikembalikan'"; // Hanya menampilkan yang statusnya "dikembalikan"
