...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $status = 'dipinjam';
    $kategori = 'opsional';  // Karena ini hanya untuk peminjaman opsional

    // Insert into peminjaman table
    $sql_peminjaman = "INSERT INTO peminjaman (id, tanggal_pinjam, status, kategori) VALUES ('$id_anggota', '$tanggal_pinjam', '$status', '$kategori')";
