...
$sql = "SELECT peminjaman.kd_peminjaman, anggota.nama, buku.judul, peminjaman.tanggal_pinjam, peminjaman.status, buku.kategori
        FROM peminjaman
...
class PDF extends PDF_MC_Table
{
    function Header()
    {
        ...
        $this->Cell(0, 10, 'LAPORAN PEMINJAMAN BUKU PERPUSTAKAAN', 0, 1, 'C');
        $this->Ln(-3);
...
$header = ['No', 'Nama', 'Judul', 'Tanggal Pinjam', 'Status', 'Kategori'];
